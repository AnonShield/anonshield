...
## Rendering Note for Future Work

When rendering full pages via `page.get_pixmap()` (e.g. if a fallback to full-page rasterisation is added), always use:
...
The PyMuPDF default of 72 DPI will produce degraded OCR results.
